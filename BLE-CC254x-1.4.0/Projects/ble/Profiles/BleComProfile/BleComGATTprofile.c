...
#define SERVAPP_NUM_ATTR_SUPPORTED        (1+4+3+2+2)
...
bStatus_t SimpleProfile_SetParameter( uint8 param, uint8 len, void *value)
{
	...
	switch ( param )
	{
		...
		case SIMPLEPROFILE_CHAR2:
			osal_memcpy((uint8 *)simpleProfileChar2,(uint8 *)value, SIMPLEPROFILE_CHAR2_LEN );
			break;

		case SIMPLEPROFILE_CHAR3:
			osal_memcpy((uint8 *)simpleProfileChar3,(uint8 *)value, SIMPLEPROFILE_CHAR3_LEN );
			break;

		case SIMPLEPROFILE_CHAR4:
			osal_memcpy(&simpleProfileChar4,(uint8 *)value, SIMPLEPROFILE_CHAR4_LEN );
			break;
...
bStatus_t SimpleProfile_GetParameter( uint8 param, void *value )
{
	...
	{
		case SIMPLEPROFILE_CHAR1:
			VOID osal_memcpy((uint8 *)value, (uint8 *)simpleProfileChar1, SIMPLEPROFILE_CHAR1_LEN );
			break;

		case SIMPLEPROFILE_CHAR2:
			VOID osal_memcpy( (uint8 *)value, (uint8 *)simpleProfileChar2, SIMPLEPROFILE_CHAR2_LEN );
			break;
		case SIMPLEPROFILE_CHAR3:
			VOID osal_memcpy( (uint8 *)value, (uint8 *)simpleProfileChar3, SIMPLEPROFILE_CHAR3_LEN );
			break;
		case SIMPLEPROFILE_CHAR4:
			VOID osal_memcpy( (uint8 *)value, &simpleProfileChar4, SIMPLEPROFILE_CHAR4_LEN );
			break;
		default:
			ret = INVALIDPARAMETER;
			break;
...
bStatus_t  OpenNotify( uint16 connHandle,bool enable)
{
   uint8 value[2]={0xB9,0X14};
   if(!enable)
   {
      value[0]=0x00;
      value[1]=0x00;
   }
   return  GATTServApp_ProcessCCCWriteReq(connHandle, &simpleProfileAttrTbl[3], value, 2,
                                              0, GATT_CLIENT_CFG_NOTIFY );
}
